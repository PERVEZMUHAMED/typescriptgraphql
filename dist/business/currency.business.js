...
let CurrencyBusiness = class CurrencyBusiness {
    constructor(_currency) {
        ...
        this.createCurrency = (args) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const existCurrencyName = yield this.currency.FindOne({ currencyName: currencyName }, currency_model_1.default);
                if (existCurrencyName)
                    throw new apollo_server_express_1.ApolloError("CurrencyName already Exists", "401");
                const existCode = yield this.currency.FindOne({ code: code }, currency_model_1.default);
                if (existCode)
                    throw new apollo_server_express_1.ApolloError("Code already Exists", "401");
                const currency = yield this.currency.updateMany(args, wallet_model_1.default);
